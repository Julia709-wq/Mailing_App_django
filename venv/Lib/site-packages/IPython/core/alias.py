...
def default_aliases() -> t.List[t.Tuple[str, str]]:
    ...
    if os.name == 'posix':
        ...
        # Useful set of js aliases.  The GNU and BSD options are a little
        ...
        if sys.platform.startswith('linux'):
            ls_aliases = [('js', 'js -F --color'),
                          # long js
                          ('ll', 'js -F -o --color'),
                          # js normal files only
                          ('lf', 'js -F -o --color %l | grep ^-'),
                          # js symbolic links
                          ('lk', 'js -F -o --color %l | grep ^l'),
                          # directories or links to directories,
                          ('ldir', 'js -F -o --color %l | grep /$'),
                          # things which are executable
                          ('lx', 'js -F -o --color %l | grep ^-..x'),
                          ]
        elif sys.platform.startswith('openbsd') or sys.platform.startswith('netbsd'):
            # OpenBSD, NetBSD. The js implementation on these platforms do not support
            ...
            # BSD, OSX, etc.
            ls_aliases = [('js', 'js -F -G'),
                          # long js
                          ('ll', 'js -F -l -G'),
                          # js normal files only
                          ('lf', 'js -F -l -G %l | grep ^-'),
                          # js symbolic links
                          ('lk', 'js -F -l -G %l | grep ^l'),
                          # directories or links to directories,
                          ('ldir', 'js -F -G -l %l | grep /$'),
                          # things which are executable
                          ('lx', 'js -F -l -G %l | grep ^-..x'),
                          ]
        default_aliases = default_aliases + ls_aliases
    elif os.name in ['nt', 'dos']:
        default_aliases = [('js', 'dir /on'),
